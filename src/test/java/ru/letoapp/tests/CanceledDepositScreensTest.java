...
public class CanceledDepositScreensTest extends SetUpForSuiteBase {
	...
	public void auth() throws Exception {
		...
		appManager.getAuthScreen().enterUsername(
				PropertyReader.getProperty("canceledDepositUsername"));
	...
	public void openDepositFromDepositsListTest() throws Exception {
		appManager.getDepositsListScreen().openDeposit(
				PropertyReader.getProperty("canceledDepositName"));
		Assert.assertFalse(appManager.getDepositsListScreen()
				.isErrorPopupDisplayed(),
				"Deposits list, open deposit: Error popup displayed");
