...
public class NotZeroWalletScreensTest extends SetUpForSuiteBase {
	...
	public void auth() throws Exception {
		...
		appManager.getAuthScreen().enterUsername(
				PropertyReader.getProperty("notZeroWalletUsername"));
	...
	public void openWalletTest() throws Exception {
		...
		Assert.assertFalse(appManager.getDashboardScreen()
				...
				"Dashboard screen, open wallet: Error popup displayed");
	...
	public void walletOperationsTest() throws Exception {
		...
		Assert.assertFalse(appManager.getWalletScreen().getWalletTab()
				.isErrorPopupDisplayed(),
				"Wallet screen: Error opening wallet operations");
		appManager.getTimelineScreen().waitForVanishUpdateSpiner();
		Assert.assertFalse(
				appManager.getTimelineScreen().isLoadingErrorExist(),
				"Wallet operations screen: Loading ERROR");
	...
	public void openInLetoBankOfficesScreenTest() throws Exception {
		...
		Assert.assertFalse(appManager.getWalletScreen().getWalletTab()
				.isErrorPopupDisplayed(),
				"Wallet screen : error opening in leto bank offices screen");
	...
	public void openAnotherBankPaymentScreenTest() throws Exception {
		...
		Assert.assertFalse(appManager.getWalletScreen().getWalletTab()
				.isErrorPopupDisplayed(),
				"Wallet screen : error opening another bank payments screen");
	...
	public void openPaymentSystemsTerminalsScreenTest() throws Exception {
		incorrectScreenHandler(walletTitle);
		appManager.getWalletScreen().getWalletTab()
				.paymentSystemsTerminalsClick();
		Assert.assertFalse(appManager.getWalletScreen().getWalletTab()
				.isErrorPopupDisplayed(),
				"Wallet screen : error opening payments system terminals screen");
	...
	public void walletOperationsFromInfoTabTest() throws Exception {
		appManager.getWalletScreen().getWalletInfoTab()
				.walletOperationsBtnClick();
		Assert.assertFalse(appManager.getWalletScreen().getWalletInfoTab()
				.isErrorPopupDisplayed(),
				"Wallet screen: Error opening wallet operations");
		appManager.getTimelineScreen().waitForVanishUpdateSpiner();
		Assert.assertFalse(
