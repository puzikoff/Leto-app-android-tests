...
public class OpenDepositScreensTest extends SetUpForSuiteBase {
	...
	public void auth() throws Exception {
		...
		appManager.getAuthScreen().enterUsername(
				PropertyReader.getProperty("openDepositUsername"));
	...
	public void openDepositTest() throws Exception {
		appManager.getDashboardScreen().openDeposit(
				PropertyReader.getProperty("openDepositName"));
		Assert.assertFalse(appManager.getDashboardScreen()
				.isErrorPopupDisplayed(),
				"Dashboard screen, open deposit: Error popup displayed");
	...
	public void changeDisplayNameTest() throws Exception {
		appManager.getDepositScreen().getEditDisplayName()
				.editDisplayNameBtnClick();
		appManager.getDepositScreen().getEditDisplayName()
				.editDisplayName(PropertyReader.getProperty("newDepositName"));
		appManager.getDepositScreen().getEditDisplayName()
				.editDisplayNamePopupNextBtnClick();
		Assert.assertFalse(appManager.getDepositScreen()
				.isErrorPopupDisplayed(),
				"Deposit screen, edit display name: error popup displayed");
		Assert.assertEquals(appManager.getDepositScreen().getEditDisplayName()
				.getDisplayName(), PropertyReader.getProperty("newDepositName"));
		appManager.getDepositScreen().getEditDisplayName()
				.editDisplayNameBtnClick();
		appManager.getDepositScreen().getEditDisplayName()
				.editDisplayName(PropertyReader.getProperty("openDepositName"));
		appManager.getDepositScreen().getEditDisplayName()
				.editDisplayNamePopupNextBtnClick();
		Assert.assertFalse(appManager.getDepositScreen()
				.isErrorPopupDisplayed(),
	...
	public void openInLetoBankOfficesScreenTest() throws Exception {
		...
		Assert.assertFalse(appManager.getDepositScreen().getDepositTab()
				.isErrorPopupDisplayed(),
				"Deposit screen : error opening in leto bank offices screen");
	...
	public void openAnotherBankPaymentScreenTest() throws Exception {
		...
		Assert.assertFalse(appManager.getDepositScreen().getDepositTab()
				.isErrorPopupDisplayed(),
				"CDeposit screen : error opening another bank payments screen");
	...
	public void openPaymentSystemsTerminalsScreenTest() throws Exception {
		incorrectScreenHandler(depositScreenTitle);
		appManager.getDepositScreen().getDepositTab()
				.paymentSystemsTerminalsClick();
		Assert.assertFalse(appManager.getDepositScreen().getDepositTab()
				.isErrorPopupDisplayed(),
				"Deposit screen : error opening payments system terminals screen");
	...
	public void depositOperationsScreenTest() throws Exception {
		incorrectScreenHandler(depositScreenTitle);
		appManager.getDepositScreen().getDepositInfoTab()
				.depositOperationsClick();
		Assert.assertFalse(appManager.getDepositScreen().getDepositInfoTab()
				.isErrorPopupDisplayed(),
				"Deposit screen: Error opening card operations");
		appManager.getTimelineScreen().waitForVanishUpdateSpiner();
		Assert.assertFalse(
				appManager.getTimelineScreen().isLoadingErrorExist(),
				"Deposit operations screen: Loading ERROR");
